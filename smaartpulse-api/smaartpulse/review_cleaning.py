...
__credits__ = []
__license__ = "Creative Commons Attribution-NonCommercial-ShareAlike " \
              "3.0 Unported License: http://creativecommons.org/" \
...
import argparse
import logging
from gensim.utils import to_unicode, to_utf8, smart_open
...
class Tokenizer:
    ...
    def tokenize_random_tweet(self):
        ...
        try:
            ...
            print "Apologies. The random tweet functionality requires " \
        ...
        if tweets:
            ...
            raise Exception("Apologies. I couldn't get Twitter to give me a "
                            "public English-language tweet. Perhaps try again")
...
def review_cleaner(corpus,logging_filename,preprocessed_file,review_tag_field,review_field,review_id,delimiter):
    logger = logging.getLogger(__name__)
    logging.basicConfig(filename=logging_filename, filemode='w',
